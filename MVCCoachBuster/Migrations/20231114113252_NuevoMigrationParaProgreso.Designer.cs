...
namespace MVCCoachBuster.Migrations
{
    ...
    [Migration("20231114113252_NuevoMigrationParaProgreso")]
    partial class NuevoMigrationParaProgreso
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCCoachBuster.Models.Progreso", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("WodXEjercicioId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVCCoachBuster.Models.Progreso", b =>
                {
                    b.HasOne("MVCCoachBuster.Models.Suscripcion", "Suscripcion")
                        .WithMany("Progresos")
                        .HasForeignKey("SuscripcionId");

                    b.HasOne("MVCCoachBuster.Models.WodXEjercicio", "WodXEjercicio")
                        .WithMany("Progresos")
                        .HasForeignKey("WodXEjercicioId");
